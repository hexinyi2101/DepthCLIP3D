...
The  depth clip model weights corresponding to Table 3 in the paper are available here: [Baidu Netdisk (code: g77n)](https://pan.baidu.com/s/1HLk5FfleWhsitWXqHypAzw?pwd=g77n)
